...
def parse_args():
    ...
    parser.add("--hubert_std_path", default="weights/hubert_std_2_scott.npy", type=str)
    parser.add("--hubert_noise_sigma", default=0.01, type=float)
    parser.add("--hubert_featdrop_p", default=0.02, type=float)
    parser.add("--hubert_timemask_w", default=2, type=int)
    parser.add("--hubert_freemask_n", default=1, type=int)
    parser.add("--fuse_dropout_p", default=0.02, type=float)
    parser.add("--load_ckpt", default=None, help="ckpt path")
    parser.add("--base_ckpt", default="weights/best_semtalk_base.bin", help="base ckpt path")
    parser.add("--kst_mode", default='s', type=str)
    parser.add("--test_stride", type=int, default="64")
    parser.add("--use_wandb", default=False, type=str2bool)
    parser.add("--wandb_name", default="h2d_motion_lm", type=str) #
    parser.add("--guide", default=False, type=str2bool)
    parser.add("--predict_type", default='motion', type=str)
    parser.add("--mask_ratio", default=0.875, type=float)
    parser.add('--addHubert',default=False,type=str2bool)
    parser.add("--train_path", default="./datasets/beat2_semtalk_train", type=str)
    parser.add("--test_path", default="./datasets/beat2_semtalk_test.pkl", type=str)
    parser.add("--local_rank", type=int, help="local rank, will passed by ddp")
    ...
    parser.add("-c", "--config", default='./configs/semtalk_base.yaml', is_config_file=True)
    ...
    parser.add("--cache_path", default="./outputs/", type=str)
    parser.add("--out_path", default="./outputs/", type=str)
    parser.add("--data_path", default="./BEAT2/beat_english_v2.0.0/", type=str)
    ...
    parser.add("--lvf", default=0., type=float)
    parser.add("--lvl", default=0., type=float)
    parser.add("--lvu", default=0., type=float)
    parser.add("--lvh", default=0., type=float)

    parser.add("--laf", default=0., type=float)
    parser.add("--lal", default=0., type=float)
    parser.add("--lau", default=0., type=float)
    parser.add("--lah", default=0., type=float)
    
    parser.add("--mf", default=0., type=float)
    parser.add("--ml", default=0., type=float)
    parser.add("--mu", default=0., type=float)
    parser.add("--mh", default=0., type=float)
    ...
    parser.add("--ori_joints_6d", default="spine_neck_141", type=str)
...
#    parser.add("--id_rep", default=None, type=str)
    ...
    parser.add("--g_name_1d_s", default="CaMN", type=str)
    parser.add("--g_name_1d_t", default="CaMN", type=str)
    parser.add("--g_name", default="CaMN", type=str)
    parser.add("--g_name_1d", default="CaMN", type=str)
    parser.add("--g_name_2d", default="CaMN", type=str)
    ...
    parser.add("--hidden_size", default=768, type=int)
    ...
    parser.add("--decay_epochs", default=60, type=int)
    parser.add("--decay_rate", default=0.3, type=float)
